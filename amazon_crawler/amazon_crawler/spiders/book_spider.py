...
class BookSpiderSpider(scrapy.Spider):
    ...
    paths = {
        ...
        'book_title': '//span[@id="btAsinTitle"]/span/text()'
                      '|//span[@id="productTitle"]/text()'
                      '|//span[@id="ebooksProductTitle"]',
        # 'review_link': '//a[@id="seeAllReviewsUrl"]/@href|//a[@id="acrCustomerReviewLink"]',
        'review_link': '//div[@id="revMHLContainer"]//a[@class="a-link-emphasis a-text-bold"]/@href',
    ...
    def parse_books(self, response):
        ...
        if review_link:
            yield scrapy.Request(response.urljoin(review_link[0]), callback=self.parse_comments,
